...
export class PsValueHolder {
    ...
    loadData() {
        ...
        this.conditionId = localStorage.conditionId;
        this.conditionName = localStorage.conditionName;
    ...
    replaceCondition(conditionId : string, conditionName : string) {
        localStorage.conditionId = conditionId;
        this.conditionId = conditionId;

        localStorage.conditionName = conditionName;
        this.conditionName = conditionName;
    }
