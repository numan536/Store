...
export default class PsUrl {
  ...
  static  ps_model_search_url = "/rest/models/search/api_key/" + PsConfig.apiKey;
  ...
  static ps_limit_ad_item_list_url = "/rest/buy_ad_post_transactions/search/api_key/" + PsConfig.apiKey;
  ...
  static  ps_model_subscription_url :String = "/rest/subcat_subscribes/subcategory_subscribe/api_key/" + PsConfig.apiKey;
  ...
  static  ps_manufacturer_url :String = "/rest/manufacturers/search/api_key/" + PsConfig.apiKey;
  ...
  static  ps_build_type_url :String = "/rest/buildtypes/get/api_key/" + PsConfig.apiKey;
