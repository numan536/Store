<template>
    <div class="cursor-text sm:w-11/12 md:w-full" >
        ...
        <ps-card class="flex-col bg-secondary-000 dark:bg-primaryDark-black lg:p-5 p-3">
            <div class="w-full">
            ...
            <div  class="w-full">
                ...
                <div class="lg:mt-2 mt-1.5 flex justify-between">
                    <ps-label  class="font-light text-sm">{{ $t("block_user_list_horizontal__followers") }} </ps-label>
                    <ps-label class="font-medium text-xl"> {{block ? block.followerCount:'0'}}</ps-label>
                </div>
                <div class="lg:mt-2 mt-1.5 flex justify-between">
                    <ps-label  class="font-light text-sm">{{ $t("block_user_list_horizontal__followings") }} </ps-label>
                    <ps-label  class="font-medium text-xl">{{block ? block.followingCount:'0'}}</ps-label>
                </div>
