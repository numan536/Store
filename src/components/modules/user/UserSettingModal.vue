    ...
    <ps-modal ref="psmodal" line="hidden" bodyHeight="max-h-90" maxWidth="784px" :isClickOut='true' class=" z-50 " >
        <template #title>
            <div class="sm:px-4 px-10 flex justify-between">
                <ps-label textColor="text-primary-500 dark:text-primaryDark-accent" class="font-medium lg:text-3xl text-xl"> {{ $t('user_setting_modal__user_setting') }} </ps-label>
                <ps-label textColor="text-primary-500 dark:text-primaryDark-accent" class="font-medium lg:text-base text-xs hover:underline cursor-pointer" @click="psmodal.toggle(false)">  {{ $t('user_setting_modal__close') }} </ps-label>
            </div>
        </template>
        <template #body>
            <div class="px-6 sm:px-0 flex sm:flex-row flex-col justify-between mt-6">
                <div class="px-4 ">
                    <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey" class="  font-medium lg:text-xs text-xxs" >  {{ $t('user_setting_modal__posts') }} </ps-label>
                    <ps-route-link class="" :to="{name: 'pending-items' }">
                        <div class='mt-4 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                    ...
                    <ps-route-link class="" :to="{name: 'reject-items' }">
                        <div class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                ...
                <div class="px-4 mt-6 sm:mt-0"> 
                    ...
                    <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey" class="font-medium lg:text-xs text-xxs" > {{ $t('user_setting_modal__activities') }} </ps-label>
                ...
                <div class="px-4 mt-6 sm:mt-0">
                    <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey" class="font-medium lg:text-xs text-xxs" > {{ $t('user_setting_modal__setting_and_privacy') }} </ps-label>
                    <ps-route-link v-if="appInfoProvider?.appInfo?.data.psAppSetting?.isBlockUser ==PsConst.ONE" class="" :to="{name: 'blocked-users' }">
                        <div class='mt-4 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                    ...
                    <div class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col' @click="openUserDeactivate(LoginUserId)">
                    ...
                    <div class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col' @click="openPasswordUpdate">
                    ...
                    <div v-if="psValueHolder.showProfile == 'show'" @click="showProfile('hide')" class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                    ...
                    <div v-else @click="showProfile('show')" class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                    ...
                    <div v-if="psValueHolder.notiSetting == 'true'" @click="shownotiSetting('hide')" class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
                        ...
                        <ps-label  class="w-full sm:w-40 lg:w-48   break-all mt-1 font-light lg:text-xs text-xxs"> {{ psValueHolder.deviceToken }}</ps-label>   
                    </div>
                    <div v-else @click="shownotiSetting('true')" class='mt-3.5 hover:bg-primary-100 dark:hover:bg-backgroundDark cursor-pointer  flex flex-col'>
