            ...
            <div class="flex flex-row items-center w-full justify-end " >
                <div class="flex-grow w-full justify-start flex flex-row">
                    ...
                    <div class="flex flex-col lg:ms-2 ms-1 my-auto">
                        <div class=" flex mt-0.5"> 
                            <ps-label class="font-medium text-xs lg:text-base"> {{chathistory ? chathistory.seller.userName : ''}} </ps-label>
                ...
                <div class="hidden sm:flex flex-col w-36 lg:w-40 ">
                    ...
                    <div class="flex flex-col">
                        <ps-label class="text-xs lg:text-sm font-medium text-center flex-shink-0 mx-auto" textColor="text-primary-500 dark:text-primaryDark-accent" > {{chathistory ? chathistory.buyerUnreadCount : '0'}}  </ps-label>
            ...
            <div class="sm:hidden flex-row flex justify-between">
                <div class="flex flex-row ">
                    <div class="flex flex-row mt-6">
                        <ps-label class="text-xs lg:text-sm font-medium text-center mx-2" textColor="text-primary-500" > {{chathistory ? chathistory.buyerUnreadCount : '0'}}  </ps-label>
                        <div v-if="chathistory?.buyerUnreadCount != '1'" class="mt-1">
