       ...
       <ps-modal ref="psmodal" line="hidden" maxWidth="500px" :isClickOut='false' > 
        ...
        <template #footer>
            <div class=" flex flex-row justify-between">
                <ps-button @click="cancel()" textSize="text-xxs lg:text-sm" class="py-3 " theme="bg-primary-000 dark:bg-secondaryDark-grey text-primary-500 dark:text-primaryDark-white"> {{ $t("review_entry__cancel") }} </ps-button>  
