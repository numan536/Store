<template>
    ...
    <div class="cursor-pointer sm:w-full md:w-full" v-on:click="onClick != null ? onClick(buyad) : null">
        <!-- Pscard -->    
        <ps-card class="flex flex-col my-2 " :enabledHover="false">

            
                <div class="pt-2 flex items-center justify-between mx-4">
                    <div class="">
                ...
                <div class="pt-2 flex items-center justify-between mx-4 ">
                    <div class="">
                        <ps-label class="font-medium text-sm lg:text-base" > {{ $t("profile__buy_limit_ad_payment") }} </ps-label>
                    </div>
                    <div class="">
                        <ps-label class="ms-1 font-medium text-xxs lg:text-sm" > {{ buyad ? buyad?.paymentMethod : '' }} </ps-label>
                    </div>
                </div> 
                <div class="pt-2 flex items-center justify-between mx-4 mb-4">
                    <div class="">
                        <ps-label class="font-medium text-sm lg:text-base" > {{ $t("profile__buy_limit_ad_date") }} </ps-label>
                    </div>
                    <div class="">
