<template>
    <ps-modal ref="psmodal" line="hidden" maxWidth="400px" :isClickOut='false' theme=" lg:px-8 px-6 py-6 lg:rounded-2xl rounded-xl" class=' z-20'>
        <template #title>
        ...
        <template #footer>
            <div class=" flex justify-center">
                <div class="flex-grow-0"> 
                    <ps-button @click="actionClicked()" textSize="text-xxs lg:text-sm" class="py-2 shadow-buttonShadow hover:shadow-none"  > {{okButton}} </ps-button>                 
                </div>
