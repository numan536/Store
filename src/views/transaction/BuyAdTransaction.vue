        ...
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 ">
                <div class=" flex items-center "> 
                        ...
                        <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey " class=" text-xxs " > {{ $t("user_setting_modal__limit_ads") }} </ps-label>
                    </div>
                <div class="flex flex-col items-start">
                    <div class="w-full flex flex-row justify-between">  
                        ...
                        <ps-label @click="buyAdClick" class='flex-grow-0 bg-primary-500 dark:bg-primaryDark-accent font-medium cursor-pointer sm:text-xs sm:w-32 w-10  ps-3.5 pe-1 sm:ps-4 sm:pe-3 py-1' textColor="text-textLight dark:text-textDark" > 
                    ...
                    <div class='w-full flex flex-col items-start ' >
                        <div class="w-full">
                            ...
                            <div v-if="limitProvider.buyadList?.data != null">
                                <div class="grid lg:grid-cols-12 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4">
                            
                                    <div class="w-full col-span-4 sm:col-span-2 lg:col-span-4" v-for="buyad in limitProvider.buyadList.data" :key="buyad.id">
