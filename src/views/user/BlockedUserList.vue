        ...
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 ">
                <div class=" flex items-center "> 
                    ...
                    <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey " class="font-light text-xxs "> {{ $t("block_user_list__block_user_list") }} </ps-label>
                </div>
                <div class="flex flex-col items-start">
                    <ps-label-header-4 class=" mb-1 font-medium"> {{ $t("block_user_list__block_user_list") }}</ps-label-header-4>
                    <ps-label class="text-xs lg:text-sm  mb-5 font-light"> {{ $t("block_user_list__text") }}</ps-label>
                </div>
