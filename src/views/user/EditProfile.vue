    ...
    <ps-content-container>
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16">
                <div class=" ms-4 flex items-center" v-if="userProvider.user?.data != null"> 
                    ...
                    <ps-label textColor="text-secondary-400 dark:text-secondaryDark-grey " class="font-light text-xxs " > {{ $t("edit_profile__edit_profile") }} </ps-label>
                </div>

                <div class="flex flex-col items-center">
                    <ps-label-header-4 class="font-medium mb-5"> {{ $t("edit_profile__edit_profile") }} </ps-label-header-4>
                </div>
